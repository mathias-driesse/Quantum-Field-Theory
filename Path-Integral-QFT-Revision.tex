...
\begin{equation}
\begin{aligned}
    \ev{T\left\{\phi(x_1) \dots \phi(x_r)\right\} T \left\{\phi(x_{r+1}) \dots \phi(x_n)\right\}}{0} = \sum_\sigma \int d\Omega_p \, \mel{0}{T\left\{\phi(x_1) \dots \phi(x_r)\right\} }{p, \sigma} \mel{p, \sigma}{T \left\{\phi(x_{r+1}) \dots \phi(x_n)\right\}}{0}
\end{aligned}
\end{equation}
...
\begin{equation} \label{eq:x_to_y_mel}
    \mel{0}{T\left\{\phi(x_1) \dots \phi(x_r)\right\}}{p, \sigma} = e^{-ip \cdot x_1} \mel{0}{T\left\{\phi(0) \dots \phi(y_r)\right\}}{p, \sigma}.
\end{equation}
...
\begin{aligned}
    ...
    &\times \sum_\sigma \int d\Omega_p \, e^{-ip \cdot x_1}\mel{0}{T\left\{\phi(0) \dots \phi(y_r)\right\} }{p, \sigma} e^{ip \cdot x_{r+1}}\mel{p, \sigma}{T \left\{\phi(0) \dots \phi(y_n)\right\}}{0}.
\end{aligned}
\end{equation}
...
\begin{aligned}
    ...
    &\times \sum_\sigma \int d\Omega_p \,\mel{0}{T\left\{\phi(0) \dots \phi(y_r)\right\} }{p, \sigma} \mel{p, \sigma}{T \left\{\phi(0) \dots \phi(y_n)\right\}}{0} \\
    &\times \hat{\delta}(\vb{p} - \vb{p}_1 - \dots - \vb{p}_r) \delta(E_p + \omega - p_1^0 - \dots - p_r^0) \\
    &\times \hat{\delta}(\vb{p} - \vb{p}_{r+1} - \dots - \vb{p}_n) \delta(E_p + \omega - p_{r+1}^0 - \dots - p_n^0).
\end{aligned}
\end{equation}
...
\begin{equation}
    \delta(\vb{p}_1 + \dots + \vb{p}_n) \text{ and } \delta(p_1^0 + \dots + p_n^0) \frac{1}{q^0 - E_p + i\epsilon},
\end{equation}
...
\begin{equation}
    \frac{1}{q^0 - E_p + i\epsilon} \rightarrow \frac{2E_p}{q^2-m_{\text{phys}}^2 + i\epsilon}.
\end{equation}
