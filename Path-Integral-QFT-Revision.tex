...
\begin{equation}
\begin{aligned}
    \ev{T\left\{\phi(x_1) \dots \phi(x_r)\right\} T \left\{\phi(x_{r+1}) \dots \phi(x_n)\right\}}{0} = \int d\Omega_p \, \mel{0}{T\left\{\phi(x_1) \dots \phi(x_r)\right\} }{p, \sigma} \mel{p, \sigma}{T \left\{\phi(x_{r+1}) \dots \phi(x_n)\right\}}{0}
\end{aligned}
\end{equation}
...
\end{equation}
The exact same procedure can be undergone for the other $T$-ordered product.

The argument of the Heaviside theta function can be rewritten as 
\begin{equation}
